...
def side(window_name):
    ...
    def dev():
        ...
        Label(faq_box,text="Copyright (c) 2021.All rights reserved",font="Helvetica 10").grid(row=2,column=0,sticky=t.W)
        Label(faq_box,text="Developed by: Aswin Thotapalli",font="Times 20 bold").grid(row=3,column=0,pady=5,sticky=t.W)
        ...
        Label(faq_box,text="aswin@cbytechains.com",font="Helvetica 10",fg="blue").grid(row=5,column=0)
        def bck(event):
            top.destroy()
        top.bind("<Escape>",bck)
        top.focus_force()
